...
#pragma region POST-PROCESSING PASS
	...
	if (m_PostProcessingMaterials.size() > 0)
	{
		...
		SpriteRenderer::Get()->DrawImmediate(m_SceneContext.d3dContext, pPrevRenderTarget->GetColorShaderResourceView(), XMFLOAT2{ 0, 0 }, XMFLOAT4{ Colors::White }, XMFLOAT2{ 0, 0 }, XMFLOAT2{ 1.f, 1.f });
